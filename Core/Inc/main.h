...
/* Private defines -----------------------------------------------------------*/
#define SPI_DRDY_Pin GPIO_PIN_1
#define SPI_DRDY_GPIO_Port GPIOA
#define SPI_DRDY_EXTI_IRQn EXTI1_IRQn
#define SPI1_CS_Pin GPIO_PIN_4
#define SPI1_CS_GPIO_Port GPIOA
#define SPI1_CS_EXTI_IRQn EXTI4_IRQn
#define WIFI_BOOT_Pin GPIO_PIN_0
#define WIFI_BOOT_GPIO_Port GPIOB
#define CAN_TERM_Pin GPIO_PIN_8
#define CAN_TERM_GPIO_Port GPIOA
#define CAN_SILENT_Pin GPIO_PIN_10
#define CAN_SILENT_GPIO_Port GPIOA
#define CHIP_EN_Pin GPIO_PIN_4
